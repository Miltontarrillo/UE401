 ...
 * @author MILTON
 */
public class MenuComputadora extends javax.swing.JFrame {

    /**
     * Creates new form MenuComputadora
     */
    public MenuComputadora() {
        initComponents();
        setSize(500,310);
    ...
    private void initComponents() {
        ...
        setTitle("Mantenimiento Computadora");
        ...
        jLabel1.setText("Id Computadora");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        DatosComputadora ini=new DatosComputadora();

        ini.setIdcomputadora(txtCodigo.getText());
        ini.setNombrepc(txtNombre.getText());
        ini.setIp(txtIP.getText());
        ini.setSo(txtSO.getText());
        ini.setEstado(txtEstado.getText());
        
        OperacionComputadora oa=new OperacionComputadora();
        boolean x=oa.agregarComputadora(ini);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        ListarComputadora lc =new ListarComputadora();
        lc.show();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        OperacionComputadora ps=new OperacionComputadora();
        DatosComputadora data=ps.buscarComputadora(cod);

        if(data!=null)
        {
            txtCodigo.setText(data.getIdcomputadora());
            txtNombre.setText(data.getNombrepc());
            txtIP.setText(data.getIp());
            txtSO.setText(data.getSo());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MenuComputadora.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MenuComputadora().setVisible(true);
            }
        });
    }
    ...
    Conexion xe=new Conexion();
        MetodoComputadora insta = new MetodoComputadora();
    
         private void eliminar(){          
             try{            
              
                 String cod=(JOptionPane.showInputDialog("Escribe el codigo a buscar"));
             if( insta.eliminarComputadora(cod, xe.abrirOracle())){              
